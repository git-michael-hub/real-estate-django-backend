...
export default function New() {
    ...
    return (
        <main id="new-listing-page">
            <form id="new-listing-page-container" onSubmit={submitForm}>
                ...
                <section className="listing-details">
                    ...
                    <input type="checkbox" name="is_available" defaultChecked={true} style={{ visibility: "hidden" }} />
                    <input type="hidden" name="seller" defaultValue={user?.id} />
                    <BtnBasic id="create-new-listing-btn" type="submit">
                        Create Listing
                    </BtnBasic>
                </section>
            </form>
