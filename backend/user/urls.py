...
from .views import user_login_view, user_create_view, user_detail_view, user_logout_view, password_reset, request_password_reset, email_verification_request_view
